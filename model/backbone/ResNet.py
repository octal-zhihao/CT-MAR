...
class BasicBlock(nn.Module):  #### 用于resnet 18,34-layer的基本模块
    expansion = 1
...
class Bottleneck(nn.Module):  ### 50,101,152layer的基本模块
    expansion = 4
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, num_layer, n_classes=1000, input_channels=3):
        ...
        #         self.conv1 = nn.Conv2d(input_channels, 64, kernel_size=3, stride=2, padding=3, bias=False)   修改
        ...
        self.fc = nn.Linear(block.expansion * 512, 1000)
